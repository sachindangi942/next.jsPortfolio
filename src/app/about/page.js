...
const About = () => {
  ...
  return (
    <motion.section
      id="about"
      className="py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gay-900 via-purple-900 to-gray-800 text-white dark:from-gray-900 dark:to-gray-800 transition-all duration-500"
      initial={{ opacity: 0 }}
